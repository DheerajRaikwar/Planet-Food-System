...
public class ViewMenuFrame extends javax.swing.JFrame {
    ...
    public ViewMenuFrame() {
        ...
        try{
            ...
            DefaultTableModel model=(DefaultTableModel)jtAllMenu.getModel();
            ArrayList<Product>menulist=ProductDao.getMenuList();
            jtAllMenu.removeAll();
            for(Product p:menulist)
            {
                rows[0]=p.getProductName();
                rows[1]=p.getProductPrice();
                model.addRow(rows);
            }
        }
    ...
    private void initComponents() {
        ...
        jtAllMenu = new javax.swing.JTable();
        ...
        jLabel2.setText("ALL PRODUCT MENU PANEL");

        jLabel3.setBackground(new java.awt.Color(0, 153, 153));
        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("ALL MENU");
        ...
        jtAllMenu.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtAllMenu);
    ...
    private javax.swing.JTable jtAllMenu;
